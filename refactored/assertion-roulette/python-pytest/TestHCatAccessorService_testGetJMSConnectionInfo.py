...
class TestHCatAccessorService:
    def test_get_jms_connection_info(self):
        ...
        assert conn_info.get_jndi_properties_string() == "java.naming.factory.initial#Dummy.Factory;java.naming.provider.url#tcp://broker.blue:61616", "Explanation message"

        conn_info = hcat_service.get_jms_connection_info(URI("http://unknown:9999/fs"))
        assert conn_info.get_jndi_properties_string() == "java.naming.factory.initial#org.apache.activemq.jndi.ActiveMQInitialContextFactory;" \
                                                         "java.naming.provider.url#vm://localhost?broker.persistent=false", "Explanation message"
