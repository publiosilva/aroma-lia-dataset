...
namespace DefaultNamespace
{
    ...
    {
        [Fact]
        public void UnsetZeroFlagWhenFalseForCPIXD11()
        {
            {
        ...
        [Fact]
        public void UnsetZeroFlagWhenFalseForCPIXD12()
        {
            {
                var fakeBus = A.Fake<IBus>();
                var program = new Dictionary<ushort, byte>
        ...
        [Fact]
        public void UnsetZeroFlagWhenFalseForCPIXD13()
        {
            {
                var fakeBus = A.Fake<IBus>();
                var program = new Dictionary<ushort, byte>
        ...
        [Fact]
        public void UnsetZeroFlagWhenFalseForCPIXD14()
        {
            {
                var fakeBus = A.Fake<IBus>();
                var program = new Dictionary<ushort, byte>
        ...
        [Fact]
        public void UnsetZeroFlagWhenFalseForCPIXD15()
        {
            {
                var fakeBus = A.Fake<IBus>();
                var program = new Dictionary<ushort, byte>
        ...
        [Fact]
        public void UnsetZeroFlagWhenFalseForCPIXD16()
        {
            {
                var fakeBus = A.Fake<IBus>();
                var program = new Dictionary<ushort, byte>
        ...
        [Fact]
        public void UnsetZeroFlagWhenFalseForCPIXD17()
        {
            {
                var fakeBus = A.Fake<IBus>();
                var program = new Dictionary<ushort, byte>
        ...
        [Fact]
        public void UnsetZeroFlagWhenFalseForCPIXD18()
        {
            {
                var fakeBus = A.Fake<IBus>();
                var program = new Dictionary<ushort, byte>
        ...
        [Fact]
        public void UnsetZeroFlagWhenFalseForCPIXD19()
        {
            {
                var fakeBus = A.Fake<IBus>();
                var program = new Dictionary<ushort, byte>
