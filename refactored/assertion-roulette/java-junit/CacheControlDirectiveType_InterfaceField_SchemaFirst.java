    ...
    public void cacheControlDirectiveType_InterfaceField_SchemaFirst() {
        {
            ...
            assertEquals("Explanation message", 500, obj.getMaxAge());
            assertEquals("Explanation message", CacheControlScope.Private, obj.getScope());
            assertEquals("Explanation message", true, obj.isInheritMaxAge());
        }
    }
}
