...
public class AZOtherInstanceImpl_ESTest extends AZOtherInstanceImpl_ESTest_scaffolding {
  ...
  public void test44()  throws Throwable  {
      ...
      assertFalse("Explanation message", boolean0);
      assertEquals("Explanation message", 121, aZOtherInstanceImpl0.getUDPListenPort());
      assertEquals("Explanation message", 0, aZOtherInstanceImpl0.getUDPNonDataListenPort());
      assertEquals("Explanation message", 0, aZOtherInstanceImpl0.getTCPListenPort());
  }
}
