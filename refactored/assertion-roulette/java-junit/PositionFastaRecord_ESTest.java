...
public class PositionFastaRecord_ESTest extends PositionFastaRecord_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      assertEquals("Explanation message", "ml9H%7|,g{C$R-jG:Hx", positionFastaRecord1.getComment());
      assertEquals("Explanation message", "PositionSequenceFastaRecord [identifier=, comments=, positions=pb995}/N]", positionFastaRecord1.getId());
  }
}
