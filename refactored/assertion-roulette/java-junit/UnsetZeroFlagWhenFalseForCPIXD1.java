...
public class ComparisonsShould {
    ...
    public void unsetZeroFlagWhenFalseForCPIXD1() {
        ...
        cpu.step();
        assertEquals("Explanation message", 0x02, cpu.A);
        assertTrue("Explanation message", (cpu.F & Z80.Flags.N) == Z80.Flags.N);
        ...
        assertFalse("Explanation message", (cpu.F & Z80.Flags.H) == Z80.Flags.H);
