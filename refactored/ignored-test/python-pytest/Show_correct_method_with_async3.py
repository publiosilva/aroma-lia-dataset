...
class TestCallSite:
    ...
    def test_show_correct_method_with_async3(self):
        ...
        log_factory.assert_debug_last_message(current_method_full_name + "|direct")
        InnerClassAsyncMethod3().async_method3a(log_factory).wait()
        log_factory.assert_debug_last_message(str(InnerClassAsyncMethod3) + ".AsyncMethod3b|direct")
