public class TestCoordSubmitXCommand extends TestCase {
    public void testBasicSubmitWithMultipleInstancesInputEvent1() throws Exception {
    ...
    public void testBasicSubmitWithMultipleInstancesInputEvent2() throws Exception {
        Configuration conf = new XConfiguration();
        String appPath = "file://" + getTestCaseDir() + File.separator + "coordinator.xml";
    ...
    public void testBasicSubmitWithMultipleInstancesInputEvent3() throws Exception {
        Configuration conf = new XConfiguration();
        String appPath = "file://" + getTestCaseDir() + File.separator + "coordinator.xml";
    ...
    public void testBasicSubmitWithMultipleInstancesInputEvent4() throws Exception {
        Configuration conf = new XConfiguration();
        String appPath = "file://" + getTestCaseDir() + File.separator + "coordinator.xml";
