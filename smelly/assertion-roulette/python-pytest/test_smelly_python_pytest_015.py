...
def test00():
    ...
    assert position_fasta_record1.get_comment() == "ml9H%7|,g{C$R-jG:Hx"
    assert position_fasta_record1.get_id() == "PositionSequenceFastaRecord [identifier=, comments=, positions=pb995}/N]"
